...
TARGET_DIR	= .
SUPPORT_DIR    	= ..\BREW_AEE_11
SUPPORT_INCDIR 	= ..\BREW_inc_11

TARGET     = $(TARGET_DIR)\RocketWeb  # Target name for output files and object dir
...
DYNAPP          = -DDYNAMIC_APP -DGEEKS_RULE #-D_DEBUG
...
TCC		= $(ARMBIN)\tcc			# ARM Blha blahblah
...
clean :
        ...
        -del /f AEEAppGen.o
        -del /f AEEModGen.o
        -del /f Apollo_History.o
        -del /f AppStates.o
         del /f RM_Debug.o
         del /f RM_HTMLViewer.o
         del /f RM_IWEBHTTP.o
         del /f RM_Utils.o
         del /f RocketBrowser.o
         del /f State.o
         del /f xmlparser.o
...
RM_Debug.o	: $(TARGET_DIR)\RM_Debug.c
RM_Debug.o      : $(TARGET_DIR)\inc.h
RM_HTMLViewer.o : $(TARGET_DIR)\RM_HTMLViewer.c
RM_HTMLViewer.o : $(TARGET_DIR)\inc.h
RM_IWEBHTTP.o	: $(TARGET_DIR)\RM_IWEBHTTP.c
RM_IWEBHTTP.o	: $(TARGET_DIR)\inc.h
RM_Utils.o	: $(TARGET_DIR)\RM_Utils.c
RM_Utils.o	: $(TARGET_DIR)\inc.h
RocketBrowser.o	: $(TARGET_DIR)\RocketBrowser.c
RocketBrowser.o	: $(TARGET_DIR)\inc.h
State.o: $(TARGET_DIR)\State.c
State.o: $(TARGET_DIR)\inc.h
xmlparser.o: $(TARGET_DIR)\xmlparser.c
xmlparser.o: $(TARGET_DIR)\inc.h

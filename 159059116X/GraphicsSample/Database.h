...
extern int DBThawRecord( IDBRecord *pRecord, CAppRecordPtr *ppResult );
extern int DBFreezeRecord( CAppRecordPtr pRecord, AEEDBField **ppResult );
extern int DBRecordField( IDBRecord *pRecord, 
